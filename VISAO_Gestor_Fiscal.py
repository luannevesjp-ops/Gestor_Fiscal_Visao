...
st.set_page_config(page_title="LUATECH-GESTÃO-VISÃO", layout="wide")

if 'main_container' not in st.session_state:
    st.session_state.main_container = st.empty()

SHEET_ID         = "1Y3SHW-QU7zHrVNiSN36pSoAouEEdOwvaz5YFKOYmN-A"
...
# Apps Script próprio da VISÃO (bound à planilha da VISÃO, ver
# apps_script_certificado_digital.gs) — publicado em 30/08/2026.
APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxb8d-0Iaoz5H4BjNTlGUc2FnnVF-RHH59coelrthRRdM9zdtyIZUI5hbInh1YgO2QL/exec"
...
# compartilhado for republicado com a pasta do Drive da VISÃO cadastrada em
# PASTAS_POR_ESCRITORIO; até lá a lupa simplesmente não aparece na tabela, a
# página não quebra.
APPS_SCRIPT_PDF_SITUACAO_FISCAL_URL = "https://script.google.com/macros/s/AKfycbz7FnVmU0-39_HszitoisrnNZ60fNpVVSXH55m3ufxoPmWEzj5uEy6Gsx9G87WiesXi/exec?escritorio=visao"
